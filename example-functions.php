 ...
 *
 * Be sure to replace all instances of 'cookingwithnothing_' with your project's prefix.
 ...
 */
function cookingwithnothing_show_if_front_page( $cmb ) {
 ...
 * @return bool                     True if metabox should show
 */
function cookingwithnothing_hide_if_no_cats( $field ) {
 ...
 */
function cookingwithnothing_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object
 */
function cookingwithnothing_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field object $field      Field object
 */
function cookingwithnothing_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'cookingwithnothing_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function cookingwithnothing_register_demo_metabox() {
	$prefix = 'cookingwithnothing_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'show_on_cb' => 'cookingwithnothing_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'cookingwithnothing_add_some_classes', // Add classes through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'cookingwithnothing_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'cookingwithnothing_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'cookingwithnothing_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'cookingwithnothing_before_row_if_2', // callback
...
add_action( 'cmb2_admin_init', 'cookingwithnothing_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function cookingwithnothing_register_about_page_metabox() {
	$prefix = 'cookingwithnothing_about_';
...
add_action( 'cmb2_admin_init', 'cookingwithnothing_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function cookingwithnothing_register_repeatable_group_field_metabox() {
	$prefix = 'cookingwithnothing_group_';
...
add_action( 'cmb2_admin_init', 'cookingwithnothing_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function cookingwithnothing_register_user_profile_metabox() {
	$prefix = 'cookingwithnothing_user_';
...
add_action( 'cmb2_admin_init', 'cookingwithnothing_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function cookingwithnothing_register_taxonomy_metabox() {
	$prefix = 'cookingwithnothing_term_';
...
add_action( 'cmb2_admin_init', 'cookingwithnothing_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page
 */
function cookingwithnothing_register_theme_options_metabox() {

	$option_key = 'cookingwithnothing_theme_options';
 ...
 */
function cookingwithnothing_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 'cookingwithnothing_register_rest_api_box' );
/**
 ...
 */
function cookingwithnothing_register_rest_api_box() {
	$prefix = 'cookingwithnothing_rest_';
	...
	$cmb_rest = new_cmb2_box( array(
		...
		// 'get_box_permissions_check_cb' => 'cookingwithnothing_limit_rest_view_to_logged_in_users',
	) );
